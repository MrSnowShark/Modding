...
public class GuiCombiner extends GuiContainer {
	...
	public GuiCombiner(InventoryPlayer player, TileEntityCombiner tileentity) {
		super(new ContainerCombiner(player, tileentity));
		this.player = player;
	...
	protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY) {
		...
		if (TileEntityCombiner.isBurning(tileentity)) {
