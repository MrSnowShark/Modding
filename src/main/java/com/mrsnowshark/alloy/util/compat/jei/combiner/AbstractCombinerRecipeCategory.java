...
public abstract class AbstractCombinerRecipeCategory<T extends IRecipeWrapper> implements IRecipeCategory<T> {

	protected static final ResourceLocation TEXTURES = new ResourceLocation(Reference.MOD_ID + ":textures/gui/combiner.png");
	...
	public AbstractCombinerRecipeCategory(IGuiHelper helper) {
