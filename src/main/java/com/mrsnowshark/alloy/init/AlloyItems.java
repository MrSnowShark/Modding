...
public class AlloyItems {
	...
	public static final Item MEGAMITE_CHESTPLATE = new ArmorBase("megamitechestplate", MMA, 1,
			EntityEquipmentSlot.CHEST);
	public static final Item MEGAMITE_LEGGINGS = new ArmorBase("megamiteleggings", MMA, 2,
			EntityEquipmentSlot.LEGS);
	...
	public static final Item IRONGOLD_CHESTPLATE = new ArmorBase("irongoldchestplate", IGA, 1,
			EntityEquipmentSlot.CHEST);
	public static final Item IRONGOLD_LEGGINGS = new ArmorBase("irongoldleggings", IGA, 2,
			EntityEquipmentSlot.LEGS);
	...
	public static final Item EMERALD_CHESTPLATE = new ArmorBase("emeraldchestplate", EMA, 1,
			EntityEquipmentSlot.CHEST);
	public static final Item EMERALD_LEGGINGS = new ArmorBase("emeraldleggings", EMA, 2,
			EntityEquipmentSlot.LEGS);
	...
	public static final Item OBSIDIAN_CHESTPLATE = new ArmorBase("obsidianchestplate", OBA, 1,
			EntityEquipmentSlot.CHEST);
	public static final Item OBSIDIAN_LEGGINGS = new ArmorBase("obsidianleggings", OBA, 2,
			EntityEquipmentSlot.LEGS);
